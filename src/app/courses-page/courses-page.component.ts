...
export class CoursesPageComponent {
  ...
  contentInfo: CourseInfo[] = [
    {title:'Tronco Común', description:'El tronco común es la base de nuestro curso, aqui aprenderás los fundamentos de la programación, el lenguaje de programación Java, los principioos S.O.L.I.D., el control de versiones con git y github y mucho más. Este curso es ideal para aquellos que quieren empezar desde cero o para aquellos que quieren reforzar sus conocimientos.', imagePath:'assets/images/TroncoComunV2.png'},
    {title:'Desarrollador Backend', description:'Como desarrollador Backend, aprenderás a construir y mantener la lógica del lado del servidor, así como a gestionar las bases de datos y la comunicación entre el servidor y el cliente.\n ademas de las pruebas unitarias, el manejo de errores y excepcionesla seguridad de la información.', imagePath:'assets/images/Backend.png'},
    {title:'Desarrollador Frontend', description:'Como desarrollador Frontend, aprenderás a construir la interfaz de usuario de las aplicaciones web, utilizando tecnologías como HTML, CSS y JavaScript.', imagePath:'assets/images/FrontEnd.png'},
